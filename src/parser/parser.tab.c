...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_UNKNOWN = 7,                    /* UNKNOWN  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_statements = 9,                 /* statements  */
...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "SEMICOLON", "UNKNOWN", "$accept", "statements", "statement", YY_NULLPTR
};
...
#line 55 "parser.y"
        ...
        node->createChild("NUMBER", (yyvsp[-1].str));

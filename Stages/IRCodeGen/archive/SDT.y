...
// Debugging
#define LINE std::cerr << "At Line: " << __LINE__ << std::endl;
// #define LINE /**/
...
declaration
    ...
    | declaration_specifiers    {
        ...
        data->inh_type = tempType; // pass the type to the init_declarator_list ⬇️
        data->inh_storageClass = storageClass; // pass the storage class to the init_declarator_list ⬇️

        LINE

        // 🧷 Attach this to NonTerminal
        $1 = data;
        } 
        init_declarator_list {
            // [ToThink about initializations 🧠 ]
        } 
        SEMI_COLON {

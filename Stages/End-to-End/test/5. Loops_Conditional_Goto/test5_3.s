#-------- 🎨 RISC-V Code Gen using C2RISC-Engine Time(2025-04-29 - 11:01:39) 🎨 ---------
...
# 👋 GetReg() for $0 = i$1 >= 10 | 🤝 `x13` reg ➜ $0 | 🤝 `x0` reg ➜ NULL | 🤝 `x12` reg ➜ i$1 |
        ...
        slt     t1, x12, t1    # Part1 of Greater Than Equal Operation - $0 = i$1 >= 10
        xori    x13, t1, 1     # Part2 of Greater Than Equal Operation - $0 = i$1 >= 10
        # 

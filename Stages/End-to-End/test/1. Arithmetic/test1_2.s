#-------- 🎨 RISC-V Code Gen using C2RISC-Engine Time(2025-04-29 - 03:37:04) 🎨 ---------
...
# 👋 GetReg() for $0 = a$1 & b$1 | 🤝 `x14` reg ➜ $0 | 🤝 `x12` reg ➜ a$1 | 🤝 `x13` reg ➜ b$1 |
        ...
        # 
# ‼️ TAC ❗️ ➔ Assign OP 🟰 - res$1 = $0
        # 
# 🤙🏼 Calling getReg() for res$1 = $0
        #  🔵 Already in register - $0 in 14
        #  🍊 Giving res$1 same reg as given to $0 due to ASSIGN-OP
        # 
# 👋 GetReg() for res$1 = $0 | 🤝 `x14` reg ➜ $0 | 🤝 `x14` reg ➜ res$1 |
        # 💛 SYM_RECORD 💛 - Setting 🚫 res$1 NOT in memory
        # 💛 SYM_RECORD 💛 - Adding 🌕 res$1 to register 14
        #  🔄 Automatic copy - of $0 into (res$1)
        # 
# ‼️ TAC ❗️ ➔ Param - param res$1
        # Adding res$1 to parameter queue
        # 
# ‼️ TAC ❗️ ➔ Function Call - $1 = call printVar, 1
        mv      a0, x14        # Move argument - res$1 into a0
        ...
        sw      x14, -28(fp)   # Store Local Var - res$1 via fp in x14
        # 💛 SYM_RECORD 💛 - Setting 🟢 res$1 in memory
        #  🫗 Finished Spilling Code 👌 

...
int width(std::string primType)
{
    ...
    widthMap[TYPE_VOID] = 0;         // Void type has no width
    widthMap[TYPE_ENUM] = WORD_SIZE; // Enum type has width of int
...
std::string maxWidth(std::string primTyp1, std::string primType2)
{
    ...
    // std::cerr << LOC << "Type 1: " << primTyp1 << " Width: " << width1 << std::endl;
    // std::cerr << LOC << "Type 2: " << primType2 << " Width: " << width2 << std::endl;
    ...
    // std::cerr << LOC << "Final Width: " << finalWidth << std::endl;
    // std::cerr << LOC << "Final Format: " << finalFormat << std::endl;
